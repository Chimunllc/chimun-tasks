...
### Кэшийн хувилбар — гараар нэмэгдүүлэх ШААРДЛАГАГҮЙ (2026-09-04)

- `sw.js`-ийн `CACHE_VERSION` нь **зөвхөн кэшийн нэр**. Шинэчлэлт утсанд хүрэх нь
  үүнээс хамаарахгүй: `index.html` / `styles.css` / `app.js` гурав **network-first +
  `cache:'reload'`** тул онлайн үед үргэлж шинэ код татагдаж, амжилттай бүрд кэшид
  дахин бичигдэнэ.
- Гараар нэмэгдүүлэх нь зэрэгцээ салбаруудад **merge конфликт** үүсгэдэг байв
  (нэг PR дээр 4 удаа: v829→v835). Тиймээс PR-ын шалгалт хасагдсан.
- **Автоматжуулах оролдлого бүтэлгүйтсэн:** main хамгаалалттай тул Actions шууд push
  хийж чадахгүй (`GH006: Required status check "lint" is expected`). Workflow устгав.
...
- `.github/scripts/check-cache-version.mjs` үлдээв — гараар шалгахад.
