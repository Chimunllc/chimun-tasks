...
// ━━━ SCAN: ХӨНГӨЛӨЛТ ЧИМЭЭГҮЙ ХАЯГДАХГҮЙ (2026-09-22) ━━━
{
  ...
  ok(/_manualDiscUsed && !_discWhy/.test(fn),
     'scan: гар хөнгөлөлтийн шалтгаан заавал (бичээгүй бол хадгалахгүй)');
  // ⛔ ГАРЦГҮЙ БАЙДАЛ — талбар олдохгүй/нуугдсан байхад шалтгаан шаардвал
  //    захиалга ХЭЗЭЭ Ч хадгалагдахгүй болно — хэрэглэгч гацна (2026-09-22 амьдаар тохиолдсон).
  ok(/_whyEl && !_whyEl\.hidden/.test(fn),
     '⛔ scan: шалтгааны талбар харагдахгүй бол шаардахгүй (гарцгүй байдал үүсгэхгүй)');
  ok(/_why\.hidden = !\(dval > 0\)/.test(fn),
     'scan: хөнгөлөлт бичигдсэн бол шалтгааны талбар ҮРГЭЛЖ харагдана');
