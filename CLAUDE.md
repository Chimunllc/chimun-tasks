...
### NOMAAD захиалга аппд орох төлөв (2026-06-16)
- Аппын NOMAAD жагсаалт `/webhook/nomaad-orders` (n8n id `2z4L2lJtTL5fRzG4`, "Shape" Code node)-оор Quote Log-оос татна. **Шүүлтүүр (2026-06-16 шинэчлэв): ЗӨВХӨН Төлөв нь "АПП" агуулсан** (`status.toUpperCase().includes('АПП')`) — өмнө ГЭРЭЭ/ГЭРЭЭ БАТЛАГДСАН байсныг хассан. Тэгэхээр Quote Log-ийн Төлөв баганад **"АПП-д нэмэх"** гэж бичсэн захиалга л аппд ордог. Гэрээ батлагдсан захиалгыг аппд харуулах бол мөн "АПП-д нэмэх" болгоно. Quote Log: `16pHiShilnG-QdZtc2ciB5JeP_aslZRcqpQqEJvD-0wA`.
