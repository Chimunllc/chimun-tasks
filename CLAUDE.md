...
- Хуучин уртын SKU-нууд (`ASAR_LEGACY_SKUS`, 19ш) нөөц 0 болсон — **устгаагүй**,
  хуучин захиалгын мөр тэдгээрийг заасаар байгаа тул архивлаагүй (архивлавал
  `loadProductsCatalog` нь `archived=eq.false` татдаг тул түүх тулгагдахаа болино).
