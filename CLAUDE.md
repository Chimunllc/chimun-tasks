...
### NOMAAD арга хэмжээний бэлтгэлийн чеклист (2026-06-10)
- NOMAAD захиалгын карт дээр **"📋 Бэлтгэл үүсгэх"** товч → стандарт бэлтгэлийн ажлуудыг үүсгэнэ (`openNomaadPrepChecklist`/`sendNomaadPrepTasks`). Загвар = `NOMAAD_PREP_CHECKLIST` (гадаа хог, ус авах, тайз/гэрэл, ширээ сандал, зүлэг, гэрэлтүүлэг г.м — энэ array-г засаж нэмнэ).
- Товчоор гараар үүсгэнэ (авто биш). Модалд зүйл бүрт хүн сонгож болно (хоосон=өөрт оноож дараа тараах). Үүсгэх: branch=camp, due=арга хэмжээний өдөр (date_start), requires_photo=true, priority=high, deadline ("09:00-аас өмнө") гарчигт. createdBy=менежер → гүйцэтгэл/чанарын системд автоматаар орно (удирдлагаас өгсөн + зурагтай баталгаажих + чанар үнэлэгдэх).
