...
- Аппын NOMAAD жагсаалт `/webhook/nomaad-orders` (n8n id `2z4L2lJtTL5fRzG4`, "Shape" Code node)-оор Quote Log-оос татна. Шүүлтүүр: `STATUSES=['ГЭРЭЭ','ГЭРЭЭ БАТЛАГДСАН','АПП-Д НЭМЭХ']` ЭСВЭЛ Төлөв нь **"АПП" агуулсан** (`status.toUpperCase().includes('АПП')`). Тэгэхээр Quote Log-ийн Төлөв баганад **"АПП-д нэмэх"** (эсвэл "АПП" агуулсан) гэж бичвэл гэрээгүй ч аппд ороно. Quote Log: `16pHiShilnG-QdZtc2ciB5JeP_aslZRcqpQqEJvD-0wA`.
