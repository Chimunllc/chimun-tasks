...
- **KPI:** роль-суурьтай **бодит дататаас авто** бодно (`roleKpi`, хувь-суурьтай, зорилтгүй): эвент/захиалгын менежер→захиалга биелүүлэлт (Дууссан/шийдэгдсэн), нягтлан→батлагдсан хүсэлтийн төлбөр гүйцэтгэл, бусад роль→зураг баталгаажуулалтын хувь (requires_photo+completion_photo_url). Дата байхгүй бол null→гар оруулга (`kpi_pct`) руу шилжинэ. **Менежерийн гар оруулга байвал автог дарна (override).** Объектив (on-time)-той давхцахгүй өөр хэмжүүр сонгосон.
