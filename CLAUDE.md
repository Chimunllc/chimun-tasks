...
- **Үнийн саналын баримт (2026-08-29 дахин зохиомж):** `buildOrderQuote(o,lang)` — NIILUULEGCH/CLIENT хайрцаг (РД, хаяг, Байршил, Түрээсийн хугацаа+хоног, «Хүргэлт…: багтсан»), барааны мөр бүрд **ЗУРАГ (40px thumbnail) + M-код + тайлбар**, төлбөрийн хайрцагт SWIFT, «ТАНЫ ХОЛБОО БАРИХ ХҮН» блок (нэвтэрсэн ажилтны нэр/албан тушаал/утас/зураг), бүтэн «Нөхцөл» догол мөр (48ц дотор цуцлахад 30%). Зургийг `quoteThumbUrl()` нь урьдчилан татаж 200px data URL болгоно — html2canvas-ийн CORS асуудлыг тойрч PDF-д ҮРГЭЛЖ гарна (татаж чадахгүй бол URL хэвээр). Popup эхлээд нээгдээд («бэлдэж байна…»), зураг бэлэн болмогц агуулга бичигдэнэ (popup blocker-оос сэргийлсэн). `CHIMUN_LEGAL`-д `swift`+`addressEn` нэмсэн. **Хийгээгүй:** CNY ханш / Alipay QR / WeChat QR (эх сурвалж, зураг байхгүй).
