...
// хүлээн авагчийн данс таарахгүй бол анхааруулна.
{
  ...
  eq(F.refundAcctDigits('Данс: 3001-234-567'), '3001234567', 'буцаалт: угтвар/зураас цэвэрлэгдэнэ');
...
{
  ok(/data-acct-copy=/.test(src), 'scan: барьцаатай картад буцаах данс харагдана');
