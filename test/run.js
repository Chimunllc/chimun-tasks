...
(async () => {
  ...
  // ── Түүхийн тайлан: мөрд орлого хуваарилах дүрэм ──
  {
    ...
    ok(R(50, 100, 80, 0) === 40, 'хуваарилалт: хөнгөлөлтөөр харьцангуй буурна');
    // Барьцаа: нийт 200 боловч 120 нь барьцаа → цэвэр 80
    ok(R(50, 100, 200, 120) === 40, 'хуваарилалт: барьцаа хасагдана');
    // Нэмэлт төлбөр (хүргэлт): нийт 150 > мөрийн нийлбэр 100 → мөр ӨСӨХГҮЙ
    ok(R(50, 100, 150, 0) === 50, 'хуваарилалт: хүргэлт/нэмэлт мөрд тарахгүй');
    ok(R(50, 100, 100, 0) === 50, 'хуваарилалт: яг таарвал мөрийн дүн');
    ok(R(50, 0, 100, 0) === 0, 'хуваарилалт: мөргүй бол 0');
    ok(R(50, 100, 0, 0) === 0, 'хуваарилалт: дүнгүй захиалга → 0');
    // Нийлбэр хадгалагдана — хөнгөлөлттэй үед мөрүүдийн нийлбэр = цэвэр дүн
    ok(Math.abs((R(60, 100, 80, 0) + R(40, 100, 80, 0)) - 80) < 1e-9, 'хуваарилалт: нийлбэр цэвэр дүнтэй тэнцэнэ');
